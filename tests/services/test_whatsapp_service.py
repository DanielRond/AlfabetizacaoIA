...
from curumim.services.whatsapp_service import (
...
@patch("curumim.services.whatsapp_service.requests.post")
def test_enviar_mensagem_texto_converte_antes_de_enviar(mock_post, monkeypatch):
    monkeypatch.setattr("curumim.services.whatsapp_service.WHATSAPP_TOKEN", "fake-token")
    monkeypatch.setattr("curumim.services.whatsapp_service.WHATSAPP_PHONE_ID", "123")
